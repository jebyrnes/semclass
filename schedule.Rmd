...
__Lectures:__  [What is SEM? A Practical and Historical Overview](lecture_pdfs/SEM_Intro_And_History.pdf)  
	...
	&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; 
	[Engines of SEM: Covariance-Based Estimation](lecture_pdfs/Intro_to_Likelihood_Fitting.pdf), [code](files/scripts/Likelihood_Fitting.R)  
...
__Lectures:__  Engines of SEM: Covariance-Based Estimation con't.  
	&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; [What does it mean to evaluate a multivariate hypothesis?](lecture_pdfs/Assesing_Likelihood_Fits.pdf), [code](files/scripts/Assessing_Likelihood.R)  
