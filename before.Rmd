...
I would then ask that you [run this script](./files/scripts/Install_Required_Packages.R) to install the packages for the course. If you have any questions, [contact me](mailto:jarrett.byrnes@umb.edu).
